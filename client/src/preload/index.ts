...
import type { AppAction, DowngradeEvent, IpcApi, LoggerEvent, LoggerMode, OpenFileOptions, OverlayPayload, OverlaySettings, RecordingStatus, SaveFileOptions, SessionLogMeta, UpdaterEvent } from "../shared/ipc-contract";
...
const api: IpcApi = {
	...
	versions: {
		...
		downgradeTo: (tag: string) => ipcRenderer.invoke("versions:downgradeTo", tag),
		onEvent: (cb) => subscribe<DowngradeEvent>("versions:event", cb),
	},
	app: {
